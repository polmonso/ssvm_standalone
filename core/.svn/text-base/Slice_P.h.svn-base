...
class Slice_P
{
 public:
  ...
  /**
   * Export a label quality file that contains one line per supernode with
   * the supernode label and number of nodes that belong to each class.
   */
  void exportSupernodeLabelQualityFile(const char* output_filename,
                                       const char* mask_dir,
                                       const int nClasses);
